...
```bash
python3 -m http.server 8000 --directory /workspace/upgraded-octo-umbrella
```
...
1. Crie/seleciona um cliente.
2. Defina o preço por m².
3. Adicione as portas (largura, altura e quantidade).
4. Guarde o orçamento.
5. Use **Gerar PDF** para imprimir/guardar como PDF.
